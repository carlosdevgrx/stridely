...
export const metadata: Metadata = {
  title: 'Política de Privacidad — Stridely',
  description: 'Cómo Stridely recoge, trata y protege tus datos personales. Cumplimiento RGPD.',
  // Canonical explícito: esta es la URL autoritativa de la política de privacidad,
  // tanto para la landing como para la app.
  ...
  return (
    <main className={s.page}>
      <div className={s.container}>
        ...
        <p className={s.updated}>Última actualización: 9 de abril de 2026</p>
