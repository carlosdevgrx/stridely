                    ...
                    <>
                      {recommendation.isRestDay ? (
                        ...
                        <>
                          ...
                          <div className="dash__ai-compact-row">
                            <span className="dash__ai-compact-type">{recommendation.sessionType}</span>
                            {recommendation.distance && (
                              <><span className="dash__ai-compact-sep">·</span><span className="dash__ai-compact-stat">{recommendation.distance}</span></>
                            )}
                            {recommendation.targetPace && (
                              <><span className="dash__ai-compact-sep">·</span><span className="dash__ai-compact-stat">{recommendation.targetPace}/km</span></>
                            )}
